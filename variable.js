...
var output1 = identity("Hello Gyani"); //  the output is a string type
console.log(output1);
var output2 = identity("it will also work"); // the output will remain string 
console.log(output2);
var output3 = identity(123); // the output will be a number
console.log(output3);
